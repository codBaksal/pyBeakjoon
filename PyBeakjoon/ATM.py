...
# countMan = int(input())
# eachMin = list(map(int, input().split()))
countMan = 5
eachMin = [3,1,4,3,2]
minSum = 0
midSum = 0
 
# eachMin = sorted(eachMin, key=lambda x : x, reverse=False)
# print(eachMin)
eachMin.sort(key=None, reverse=False)
...
# 이 문제의 핵심은?
# 정렬을 어떻게 할 것 인가? sort() or sorted()
# 이전까지의 더한 값을 기억시켜야 된다.
